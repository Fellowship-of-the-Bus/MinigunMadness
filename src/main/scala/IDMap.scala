...
object ImageID {
  implicit object Factory extends IDFactory[ImageID] {
    val ids = Vector(FotBLogo, Logo, IBlock, JBlock, LBlock, TBlock, Player1Walk, Player1Jetpack, Player2Walk, Player2Jetpack, Background, Bullet, Minigun)// GameOver, Heart, TopBorder, Background)
  }
